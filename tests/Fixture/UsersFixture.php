...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'users_FK' => ['type' => 'index', 'columns' => ['id_estado'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_user'], 'length' => []],
            'users_FK' => ['type' => 'foreign', 'columns' => ['id_estado'], 'references' => ['estados', 'id_estado'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-06-22 21:30:06',
                'modified' => '2021-06-22 21:30:06',
                'id_estado' => 1,
            ],
        ];
        parent::init();
