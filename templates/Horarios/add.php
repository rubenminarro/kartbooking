<main role="main" class="container">
	<div class="card text-white bg-secondary mb-2">
		<div class="card-header">
			<h4 class="float-left">Nuevo Horario</h4>
    ...
    <div class="col">
      <?= $this->Form->create($horario,['class'=>'needs-validation mb-3','novalidate'=>true]) ?>
				<div class="form-group">
					<label>Inicio</label>
					<input type="text" name="inicio" class="horarios form-control" placeholder="Horario de inicio" required>
				...
				<div class="form-group">
					<label>Fin</label>
					<input type="text" name="fin" class="horarios form-control" placeholder="Fin del horario" required>
					<div class="invalid-feedback">
				...
				<div class="form-group">
					...
					<input type="text" name="cantidad" class="form-control" placeholder="Ingresa la cantidad de pilotos" required>
					<div class="invalid-feedback">
